    ...
    <header className="nav-shell">
      <div className="mx-auto flex h-[4.25rem] max-w-[1400px] items-center justify-between gap-4 px-4 sm:px-6">
        <Link href="/dashboard" className="group flex items-center gap-3">
          ...
          <span className="font-display hidden text-lg font-semibold tracking-tight text-slate-900 sm:block">
            Resume Tailor
          </span>
        </Link>
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-cyan-500 text-xs font-semibold text-white shadow-[0_10px_24px_-14px_rgba(37,99,235,0.85)] ring-2 ring-white transition hover:scale-[1.03]"
          ...
          {menuOpen && (
            <div className="dropdown-menu">
              <div className="border-b border-slate-100 px-3.5 py-3">
                ...
                <p className="mt-0.5 text-[11px] text-slate-500">Account settings</p>
              </div>
              ...
              <button
                ...
                className="dropdown-item w-full border-t border-slate-100 text-left text-red-600 hover:bg-red-50"
              >
                Sign out
              </button>
            </div>
